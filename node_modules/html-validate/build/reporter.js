...
class Reporter {
    ...
    add(node, rule, message, severity, location) {
...
function countErrors(messages) {
    return messages.filter(m => m.severity === config_1.Config.SEVERITY_ERROR).length;
}
function countWarnings(messages) {
    return messages.filter(m => m.severity === config_1.Config.SEVERITY_WARN).length;
}
